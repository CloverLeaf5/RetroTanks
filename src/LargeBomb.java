...
public class LargeBomb extends BasicWeapon {

	private final int BOMB_SIZE = 10;
	private final int DAMAGE_FACTOR = 20;
	private int explosionCounter = 0;
	private int ticksSinceCollision = 0;
	private Color color = Color.WHITE;

	public LargeBomb(WeaponType type, float x, float y, float velX, float velY, float angleR, int tagNumber) {
